...
- Writing follow-up emails to doctors who haven't ordered recently
- Drafting outreach to new podiatrist offices
- Summarizing account activity or notes after a visit
- Creating simple scripts for cold calls or office visits
- Tracking talking points for specific objections 
  (e.g. "we already use another lab")

## Common Objections I Hear
- "We're happy with our current lab"
- "Your turnaround is too slow"
- "It's too complicated to switch"

## Tone
Professional but warm — like a trusted partner, not a pushy 
salesperson

## Relevant links
-Company website: Fdmotion.com
-USPS Returns label-https://returns.usps.com/Label/CreateSingle?Code=A2795AF388274D299E60767B34AB00C4&DisplayType=Customer
Scanning Tutorial:
https://youtu.be/8JfNTzzXtqI
Brace Scanning Tutorial:
https://youtu.be/-WZ9LQCo93M
Free Forward Motion App:
https://apps.apple.com/us/app/forward-motion-medical/id1169056512
Will's Calendar:
https://calendar.app.google/pijPpW5TfUUdCRXA9
-Doctor Portal:
https://orthoticsportal.com/
...
-We can refurbish an orthotic. $65 for a Non Forward Motion device. $35 if Forward Motion made it. 